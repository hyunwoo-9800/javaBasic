...
public class Q2 {
	...
	public static void main(String[] args) {
		...
		GenericStack<String> s = new GenericStack<String>(64);			// 최대 64개를 푸시 할 수 있는 스택
		...
		while (true) {
			...
			case 1:								// 푸시
				...
				x = ci.readNonBlank("데이터: ");
				
				try {
					
					s.push(x);
					
				} catch (GenericStack.OverflowInStackException e) {
			...
			case 2:								// 팝
				...
				} catch (GenericStack.EmptyInStackException e) {
			...
			case 5:								// 검색
				...
				String target = ci.readNonBlank("검색할 값을 입력해주세요.");
